...
import { SurvivalBySizeAndType as SurvivalBySizeAndTypeData } from '../../types';
import { Card } from '../common/Card';
import { LoadingOverlay } from '../common/LoadingSpinner';
import { EmptyState } from '../common/StateIndicators';

interface SurvivalBySizeAndTypeProps {
  data: SurvivalBySizeAndTypeData[];
  height?: number;
  isLoading?: boolean;
}
...
function SurvivalBySizeAndTypeComponent({
  data,
  height = 400,
  isLoading = false,
}: SurvivalBySizeAndTypeProps) {
  ...
  useEffect(() => {
    ...
    svg
      ...
      .attr('fill', '#0a3d62')
      .text('Survival by Size: Natural vs Restored Corals');
    ...
    return (
      <Card className="relative overflow-hidden">
        <EmptyState
          ...
          description="No data available for natural vs restored survival comparison."
          size="md"
        />
      </Card>
    );
...
export const SurvivalBySizeAndType = memo(SurvivalBySizeAndTypeComponent);
